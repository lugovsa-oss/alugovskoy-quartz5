...
חשוב להפנים שני דברים. ראשית, **פאזה אינה זהה למצב צבירה**: שמן ומים שניהם נוזלים והם יוצרים שתי פאזות. שמן ואלכוהול, לעומת זאת, יוצרים פאזה נוזלית אחת משותפת. הקריטריון פה אינו מצב צבירה אלא מסיסות של חומר אחד בשני. אם שני החומרים מתמוססים זה בזה, הם יוצרים פאזה אחת ללא קשר למצב הצבירה. ואם לא מתמוססים, אז כל חומר יוצר פאזה משלו. שנית, **מספר הפאזות אינו מספר החומרים**: אפשר ששני חומרים יהיו פאזה אחת (תמיסה), ואפשר שחומר אחד יופיע בשתי פאזות (קרח ומים). מים וקרח הם שתי פאזות אף שמדובר באותו חומר, ולהפך — שני מוצקים בעלי מבנה גבישי שונה הם שתי פאזות נפרדות גם ששניהם מוצקים.
...
**תמיסות מוצקות (solid solutions)** — כאן טמון חידוש שאינו אינטואיטיבי: גם מוצק יכול להיות תמיסה. תמיסה מוצקה היא גביש שבו אטומים זרים שולבו בתוך הסריג של החומר המארח, מבלי לשבור אותו לפאזה נפרדת. כפי שראינו [[courses/materials1/chapter04|בפרק על הפגמים]], השילוב יכול לקרות בשתי דרכים: אטומים זרים תופסים מקום של אטומי המארח (**תמיסה מוצקה תחליפית**, substitutional), או אטומים קטנים נדחקים לעמדות חדירויות (**תמיסה מוצקה חדירותית**, interstitial).
...
**תמיסה (solution)** — ערבוב אחיד (פאזה אחת) של שני חומרים או יותר, **ללא יחס קבוע** — ניתן להמיס מעט סוכר או הרבה סוכר, וההרכב משתנה ברציפות. אין כאן קשר כימי חזק בין הממס למומס. אין גם נוסחה כימית לתמיסה.
...
**מסיסות מלאה (מוחלטת)** — שני החומרים מתמזגים זה בזה בכל יחס שהוא, מאפס ועד מאה אחוז, ותמיד מתקבלת פאזה אחת (= מערכת הומוגנית). דוגמה נוזלית מוכרת: מים ואלכוהול — ניתן לערבב אותם בכל יחס ולעולם לא תיווצר פאזה נפרדת. גם במוצקים הדבר אפשרי: נחושת וניקל, למשל, מסיסים זה בזה לחלוטין במצב מוצק ויוצרים תמיסה מוצקה רציפה בכל הרכב (הערבוב שלהם נעשה במצב נוזלי ואז מאפשרים לתמיסה להתקרר. גם לאחר הקפאון ממשיכה המערכת להיות הומוגנית).
...
![[courses/GeneralChemistry/images/solubility.webp]]