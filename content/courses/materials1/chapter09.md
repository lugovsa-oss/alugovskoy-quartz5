...
- **קשיות אינה חוזק**, אם כי השניים קשורים (כפי שנראה בסוף הפרק).
...
קיימות כמה שיטות של מדידת הקשיות, הנבדלות בצורת החודרן, בחומר שממנו הוא עשוי, ובאופן שבו מחושב הערך המספרי של הקשיות. אין “המרה” מדויקת אחת בין הסולמות, ולכן תמיד יש לציין באיזו שיטה נמדדה הקשיות.

**סולם מוס (Mohs)** — השיטה העתיקה והפשוטה ביותר, מתחום המינרלוגיה. זהו סולם **השוואתי** (לא כמותי מוחלט) מ-1 עד 10, המבוסס על שאלה אחת: מי שורט את מי? טלק = 1 (הרך ביותר), יהלום = 10 (הקשה ביותר). מינרל שורט כל מינרל בעל מספר נמוך משלו. הסולם נוח לזיהוי מינרלים בשדה, אך אינו ליניארי ואינו מדויק דיו לצרכים הנדסיים.
