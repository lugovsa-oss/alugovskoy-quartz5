...
כדי לדבר על התנהגות מכנית באופן כמותי, אי אפשר להסתפק במושג “כוח”. כוח של 100 ניוטון יכול לכופף מוט דק או בקושי להשפיע על קורה עבה — הכול תלוי בשטח. לכן אנו זקוקים לשני מושגים מנורמלים: מאמץ ומעוות.
...
המעוות הוא גודל חסר יחידות (אורך חלקי אורך), ולעיתים מבוטא באחוזים.
...
**דחיסה (compression)** — כוחות הדוחסים את הגוף, מנסים לקצר אותו. חומרים מסוימים, כגון בטון, חזקים מאוד בלחיצה אך חלשים במתיחה — ומכאן הצורך בבטון מזוין.
