...
הסיבה לכך היא שכמעט שום חומר אינו טהור לחלוטין, ורוב החומרים אינם טהורים אפילו בקירוב. לכן, כל חומר מורכב למעשה ממספר מרכיבים או אזורים שונים. מרכיבים אלה יכולים להיות חומרים שונים, כפי שקורה באוויר, המורכב בקירוב מ־78% חנקן, 21% חמצן וכמויות קטנות של גזים נוספים. הם יכולים גם להיות אותו חומר במצבי צבירה שונים; לדוגמה, ערפל מורכב מאדי מים ומטיפות זעירות של מים נוזליים. במקרים אחרים מדובר בחומרים שונים ובמצבי צבירה שונים, כמו בקלקר, המכיל פלסטיק מוצק ואוויר גזי.

יתרה מזאת, אפילו כאשר מדובר באותו חומר ובאותו מצב צבירה, החומר עדיין אינו חייב להיות אחיד. לדוגמה, אבקת גרפיט עשויה להכיל חלקיקים של גרפיט, פולרן ופיח. אף שכל החומרים הללו מורכבים מאטומי פחמן במצב מוצק, המבנה שלהם שונה ולכן גם תכונותיהם שונות מאוד זו מזו.

כדי לתאר באופן עקבי והגיוני את כל המצבים הללו, מוגדר המונח **פאזה**.
...
פאזה היא חלק של מערכת שבו ההרכב הכימי, המבנה והתכונות אחידים, ואשר מופרד מחלקים אחרים של המערכת על ידי גבולות ברורים.
...
- ב**פלדה**, גרגרי **צמנטיט** קשים (מפוזרת) עשויים להיות מוטמעים במטריצת **פֵּרִיט** (רציפה).
...
אפילו תכונות כימיות עשויות להיות תלויות בפאזות המרכיבות את החומר. כך, למשל, סגסוגות מגנזיום–אלומיניום מורכבות בדרך כלל מפאזת **α (אלפא)**, שהיא בקירוב אלומיניום, ומפאזת **β (ביתא)**, שהיא התרכובת הבין־מתכתית Mg₁₇Al₁₂. 

עמידותה של הסגסוגת בפני קורוזיה אינה תלויה רק בהרכב הכימי הכולל שלה, כלומר באחוזי המגנזיום והאלומיניום שבה, אלא גם באופן שבו הפאזות מסודרות במיקרו־מבנה. לדוגמה, כאשר חלקיקי פאזת α מוקפים מכל עבר ברשת רציפה של פאזת β, התנהגות הקורוזיה עשויה להיות שונה באופן משמעותי מזו של סגסוגת בעלת אותו הרכב כימי אך בעלת פיזור פאזות אחר.

באחד המחקרים שערכנו בעבר הראינו שדגימות שנלקחו מאזורים שונים של אותה יציקה – האחת מליבת היציקה והאחרת משוליה – הפגינו עמידות לקורוזיה שונה לחלוטין. זאת למרות שההרכב הכימי שלהן היה זהה. הסיבה לכך הייתה ההבדל בפיזור ובמורפולוגיה של הפאזות במיקרו־מבנה, ולא הבדל כלשהו בהרכב היסודות עצמם.
דוגמה זו ממחישה היטב מדוע אין די בידיעת ההרכב הכימי של חומר כדי לחזות את תכונותיו. לעיתים קרובות, יש לדעת גם אילו פאזות קיימות בו, באילו כמויות הן מופיעות וכיצד הן מפוזרות במבנה החומר.
...
כאשר מלח מתמוסס במים נוצרת תמיסה נוזלית. באופן דומה — אף שהדבר מנוגד לאינטואיציה של רבים — גם במוצקים יכולות להיווצר תמיסות.

**תמיסה מוצקה** היא פאזה מוצקה אחת, שבה אטומים מסוג אחד מפוזרים בתוך הסריג הגבישי של חומר אחר.

מבחינה חיצונית החומר נראה אחיד לחלוטין. לא ניתן להבחין בין מרכיביו בעין, במיקרוסקופ אופטי, ולעיתים אף במיקרוסקופ אלקטרונים. האטומים מעורבים זה בזה ברמה האטומית.

עם זאת, גם כאשר בסריג הגבישי של המרכיב העיקרי מופיעים מדי פעם אטומים בודדים של מרכיב אחר, בריכוזים זעירים של חלקי אחוז בלבד, תכונות החומר עשויות להשתנות באופן דרמטי. כך, לדוגמה, חלק גדול מן האלקטרוניקה המודרנית מבוסס על כמויות זעירות של אינדיום, ארסן או יסודות אחרים המשולבים בסיליקון או בגרמניום. שינויים קטנים ביותר בהרכב עלולים לגרום לשינויים גדולים בתכונות החשמליות והאופטיות של החומר.\
...
מבחינה מושגית הן נמצאות בתווך בין תרכובת כימית קלאסית לבין סגסוגת. מצד אחד, הרכבן מוגדר הרבה יותר מאשר בתמיסה מוצקה. מצד שני, אופיין האלקטרוני ואופי הקישור האטומי שלהן מורכבים יותר, ואינם ניתנים בדרך כלל לתיאור באמצעות מודל פשוט של קשר כימי יחיד.
