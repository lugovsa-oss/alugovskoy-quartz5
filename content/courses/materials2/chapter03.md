...
### מוליכות סגולית של מוליכים שונים

מבחינה פיזיקלית, מוליכות סגולית $\sigma$ תלויה בשני גורמים עיקריים:
* מספר נושאי המטען ליחידת נפח.
* הניידות של נושאי המטען בתוך החומר.
לכן חומרים שונים יכולים להגיע לערכי מוליכות דומים באמצעות מנגנונים שונים לחלוטין: במתכות הזרם נישא על ידי אלקטרונים חופשיים, בתמיסות אלקטרוליטיות על ידי יונים, ובפלזמה על ידי אלקטרונים ויונים גם יחד.

### ערכי מוליכות אופייניים

| סוג מוליך | חומר                   | מוליכות סגולית אופיינית [S/m] |
| --------- | ---------------------- | ----------------------------: |
| ראשון     | כסף                    |           $6.3 \times 10^{7}$ |
| ראשון     | נחושת                  |           $5.9 \times 10^{7}$ |
| ראשון     | אלומיניום              |           $3.5 \times 10^{7}$ |
| ראשון     | גרפיט                  |               $10^{4}-10^{5}$ |
| שני       | מי ים                  |                           4-6 |
| שני       | תמיסת KCl מרוכזת       |                         10-15 |
| שני       | חומצה גופרתית מרוכזת   |               $10^{2}-10^{3}$ |
| שלישי     | מוליכים קרמיים מעורבים |              $10^{-1}-10^{3}$ |
| שלישי     | פלזמה בטמפרטורה גבוהה  |               $10^{3}-10^{7}$ |

הטבלה ממחישה את הפער העצום בין סוגי המוליכים: מוליכותה של נחושת גדולה פי מיליונים ואף פי עשרות מיליונים מזו של רוב האלקטרוליטים הנוזליים.

### כיצד משווים בין מתכות, אלקטרוליטים ופלזמה?
בספרות האלקטרוכימית נהוג לעיתים לתאר מוליכות של תמיסות באמצעות **מוליכות מולרית** ($\Lambda$) או **מוליכות שקולה**, ואילו בפיזיקת הפלזמה נהוג להשתמש לעיתים בהתנגדות סגולית, בתדירות התנגשויות או בפרמטרים קינטיים אחרים. צורות תיאור אלה עלולות ליצור רושם שמדובר בגדלים שאינם בני־השוואה.

למעשה, כל הגדלים הללו מתארים בסופו של דבר את אותה תופעה: יכולתו של נפח נתון של חומר להעביר מטען חשמלי בהשפעת שדה חשמלי. לכן ניתן תמיד להמירם למוליכות סגולית ($\sigma$) ביחידות (S/m), המהווה "שפה משותפת" לכל סוגי המוליכים.

כאשר מבצעים המרה כזו מתברר כי מתכות טובות מוליכות בדרך כלל בתחום של \($10^{7})-(10^{8};S/m$), גרפיט נמצא מספר סדרי גודל מתחתיהן, אלקטרוליטים מימיים נמצאים בדרך כלל בתחום של ($10^{-1})-(10^{2};S/m$), ואילו פלזמה יכולה לנוע בטווח רחב במיוחד — מערכים נמוכים יחסית ועד לערכים המתקרבים למוליכות של מתכות, בהתאם לטמפרטורה ולדרגת היינון.

מנקודת מבט זו, ההבדל בין מוליך אלקטרוני, מוליך יוני ופלזמה איננו באופן מדידת המוליכות אלא בזהות נושאי המטען ובמנגנון תנועתם. המוליכות הסגולית מאפשרת להשוות בין כל המערכות הללו באמצעות גודל פיזיקלי אחיד אחד.
...
| סוג החומר | מצב פסי האנרגיה | פער אסור אופייני $E_g$ [eV] | מוליכות סגולית אופיינית $\sigma$ [S/m] | מוליכות חשמלית |
|-----------|-----------------|-----------------------------|-----------------------------------------|----------------|
| מתכת | פס מאוכלס חלקית או חפיפת פסים | 0 | $10^6-10^8$ | גבוהה מאוד |
| מוליך למחצה | פער אנרגיה קטן | $0.1-3$ | $10^{-6}-10^4$ | בינונית |
| מבודד | פער אנרגיה גדול | $>3$ | $10^{-20}-10^{-8}$ | נמוכה מאוד |
(הערכים המובאים בטבלה הם סדרי גודל בלבד. המוליכות החשמלית עשויה להשתנות על פני תחום רחב מאוד כתלות בטמפרטורה, ברמת הטוהר, במבנה הגבישי ובמידת הסימום של החומר.)

ראוי לשים לב כי מעבר ממתכת למבודד מלווה בירידה של עשרות סדרי גודל במוליכות החשמלית. נחושת, למשל, מוליכה בקירוב $6\times10^7\text{ S/m}$, בעוד שקוורץ (SiO₂) מוליך פחות מ-$10^{-17}\text{ S/m}$. לפיכך, קיומו וגודלו של הפער האסור הם מן הגורמים המרכזיים הקובעים את תכונות ההולכה של החומר.
